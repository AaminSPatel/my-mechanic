  ...
  return (
    <div className="space-y-20 pb-20">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  ...
                  <p>
                    <span className="font-semibold text-foreground">Saturday:</span> {company.hours.saturday}
                  </p>
                  <p>
              ...
              <div>
                ...
                <p className="text-primary font-bold mt-2">{company.phone}</p>
              </div>

              <div>
                <h3 className="font-bold text-lg text-foreground mb-2">Connect With Us</h3>
                <p className="text-muted-foreground">Message us on WhatsApp for quick responses:</p>
                <a
                  href={`https://wa.me/${company.whatsapp.replace(/[^0-9]/g, '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary font-semibold hover:text-red-700 transition-colors"
                >
                  Start WhatsApp Chat
                </a>
              </div>
              ...
              <div className="bg-secondary p-6 rounded-xl">
                ...
                <p className="text-muted-foreground">
                  We serve the entire Indore region and nearby areas. Contact us to confirm service availability for
                  your location.
                </p>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full h-96 bg-secondary rounded-xl border border-border flex items-center justify-center">
